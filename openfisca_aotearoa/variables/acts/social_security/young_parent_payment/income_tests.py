"""This module provides the calculation of Youth Parent Payment's Income Tests."""
...
class youth_parent_payment__income_test_1(dictionary.social_security__income_test_1):
    label = "Youth Parent Payment — Income Test 1"
    ...
    def formula_2018_11_26(families, period, params):
        ...
        applicable_rate = families.sum(
            people("youth_parent_payment__base", period),
        ...
        total_income = families("youth_parent_payment__income", period)
...
class youth_parent_payment__income_test_2(dictionary.social_security__income_test_1):
    label = "Youth Parent Payment — Income Test 2"
    reference = "https://www.legislation.govt.nz/act/public/2018/0032/latest/whole.html#DLM6784375"
    documentation = """
...
class youth_parent_payment__income_test_3(dictionary.social_security__income_test_3):
    label = "Youth Parent Payment — Income Test 3"
    reference = "https://www.legislation.govt.nz/act/public/2018/0032/latest/whole.html#DLM6784375"
    documentation = """
...
class youth_parent_payment__income_test_4(dictionary.social_security__income_test_4):
    label = "Youth Parent Payment — Income Test 4"
    reference = "https://www.legislation.govt.nz/act/public/2018/0032/latest/whole.html#DLM6784375"
    documentation = """
