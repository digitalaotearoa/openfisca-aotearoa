...
class supported_living_payment__entitled(variables.Variable):
    ...
    def formula_2018_11_26(persons, period, parameters):
        ...
        ssa40 = persons("supported_living_payment__carer__entitled", period)
    ...
    def formula(persons, period, parameters):
        ...
        """
        ssa40B = persons("supported_living_payment__disabled_or_blind__entitled", period)
        ssa40D = persons("supported_living_payment__carer__entitled", period)
...
class supported_living_payment__disabled_or_blind__entitled(variables.Variable):
    ...
    def formula_2018_11_26(persons, period, parameters):
        ...
        ssa36 = not_(persons("supported_living_payment__disability_self_inflicted", period))
    ...
    def formula(persons, period, parameters):
        ...
        # person P is ineligible if the disability was self-inflicted to gain benefits
        ssa40B_5 = not_(persons("supported_living_payment__disability_self_inflicted", period))
