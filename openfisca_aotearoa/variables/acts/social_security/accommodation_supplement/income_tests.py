"""This module provides the calculation of Accommodation Supplement's Income Tests."""
...
class accommodation_supplement__income_test_1(dictionary.social_security__income_test_1):
    label = "Accommodation Supplement — Income Test 1"
    ...
    def formula_2018_11_26(families, period, params):
        ...
        applicable_rate = families.sum(
            people("accommodation_supplement__base", period),
        ...
        total_income = families("accommodation_supplement__income", period)
...
class accommodation_supplement__income_test_2(dictionary.social_security__income_test_1):
    label = "Accommodation Supplement — Income Test 2"
    reference = "https://www.legislation.govt.nz/act/public/2018/0032/latest/whole.html#DLM6784375"
    documentation = """
...
class accommodation_supplement__income_test_3(dictionary.social_security__income_test_3):
    label = "Accommodation Supplement — Income Test 3"
    reference = "https://www.legislation.govt.nz/act/public/2018/0032/latest/whole.html#DLM6784375"
    documentation = """
    ...
    def formula_2018_11_26(families, period, params):
        ...
        scale = params(period).social_security.dictionary.income_test_3b
...
class accommodation_supplement__income_test_4(dictionary.social_security__income_test_4):
    label = "Accommodation Supplement — Income Test 4"
    reference = "https://www.legislation.govt.nz/act/public/2018/0032/latest/whole.html#DLM6784375"
    documentation = """
